    ...
    <div class="container">
        <div class="grid md:grid-cols-12 items-center">
            <div class="md:col-span-3">
                <a href="{{ route('index') }}" class=" opacity-50">
            ...
            <div class="md:col-span-5 md:mt-0 mt-8">
                <div class="text-center">
                    <p class="text-gray-400">©
                        ...
                        S&K PRODUCTION <i class="mdi mdi-heart text-orange-700"></i>
                        <a href="{{ route('index') }}" target="_blank" class="text-reset">
                            אולפן הפקת וידאו מסך ירוק בדרום - באר שבע
                        </a>
                    </p>
                </div>
            </div>
            ...
            <div class="md:col-span-4 md:mt-0 mt-8">
                <ul class="list-none foot-icon ltr:md:text-right rtl:md:text-left text-center">
                    <li class="inline"><a href="https://www.youtube.com/channel/UCGCj_IYRa8bFcJEPvvtIncw"
                                          target="_blank"
