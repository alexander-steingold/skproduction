    ...
    <div class="container flex flex-wrap items-center justify-end">
        <a class="navbar-brand" href="index.html">
            <span class="inline-block dark:hidden">
                <img src="{{ asset('theme/src/assets/images/logo-dark.png') }}" class="l-dark" alt="">
                <img src="{{ asset('theme/src/assets/images/logo-light.png') }}" class="l-light" alt="">
            </span>
            <img src="{{ asset('theme/src/assets/images/logo-light.png') }}" class="hidden dark:inline-block" alt="">
        </a>
